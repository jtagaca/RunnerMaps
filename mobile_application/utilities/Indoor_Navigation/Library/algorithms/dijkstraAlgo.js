...
export const dijkstraAlgo = (grid, initPos) => {
  // should be flipped? ↓ end and start
  ...
  while (!queue.isEmpty()) {
    ...
    if (
      currentRowIdx != 0 &&
      tGrid[currentRowIdx - 1][currentColIdx] != "WALL" &&
      tGrid[currentRowIdx - 1][currentColIdx] != "ROOM"
    ) {
      if (tGrid[currentRowIdx - 1][currentColIdx] == -50) {
        tGrid[currentRowIdx - 1][currentColIdx] =
          tGrid[currentRowIdx][currentColIdx] + 1;
        break;
        ...
        tGrid[currentRowIdx - 1][currentColIdx] = Math.min(
          tGrid[currentRowIdx - 1][currentColIdx],
          tGrid[currentRowIdx][currentColIdx] + 1
        );
      }
    ...
    if (
      currentColIdx != 0 &&
      tGrid[currentRowIdx][currentColIdx - 1] != "WALL" &&
      tGrid[currentRowIdx][currentColIdx - 1] != "ROOM"
    ) {
      if (tGrid[currentRowIdx][currentColIdx - 1] == -50) {
        ...
        tGrid[currentRowIdx][currentColIdx - 1] = Math.min(
          tGrid[currentRowIdx][currentColIdx - 1],
          tGrid[currentRowIdx][currentColIdx] + 1
        );
      }
...
const findShortPath = (grid, initPos) => {
  ...
  while (currentRowIdx != endRowIndex || currentColIdx != endColIndex) {
    ...
    if (
      currentRowIdx != 0 &&
      grid[currentRowIdx - 1][currentColIdx] ==
        grid[currentRowIdx][currentColIdx] - 1
    ) {
